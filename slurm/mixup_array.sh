...
# Submit with:
#   sbatch --export=ALL,RUN_TS=$(date +%Y-%m-%d_%H%M),HF_HOME=/home/ak562fx/.cache/huggingface slurm/mixup_array.sh
...
echo "Running: method=mixup model=${MODEL} held_out_domain=${HELD_OUT}"
