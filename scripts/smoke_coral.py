"""Run all 12 CORAL smoke tests (1 epoch) sequentially by default.

Usage:
    python scripts/smoke_coral.py                       # 1 worker default
    python scripts/smoke_coral.py --workers 4           # parallel (GPU contention warning)
