"""Run all 12 Mixup smoke tests (1 epoch) sequentially by default.

Usage:
    python scripts/smoke_mixup.py                       # 1 worker default
    python scripts/smoke_mixup.py --workers 4           # parallel (GPU contention warning)
