"""Run all 12 MAML smoke tests (1 epoch) sequentially by default.

Usage:
    python scripts/smoke_maml.py                       # 1 worker default
    python scripts/smoke_maml.py --workers 4           # parallel (GPU contention warning)
